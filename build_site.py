...
.wrap{max-width:1000px;margin:0 auto;padding:clamp(44px,8vw,96px) clamp(20px,5vw,56px) 40px;flex:1}
...
.docs{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:20px;margin:52px 0 0}
...
.doc .meta{margin:18px 0 0;font:500 .74rem/1 var(--f-ui);letter-spacing:.08em;text-transform:uppercase;color:var(--faint);
  display:flex;align-items:center;gap:8px}
.doc .go{margin-left:auto;color:var(--accent);letter-spacing:0;text-transform:none;font-size:.82rem}
...
footer .wrap{padding-top:26px;padding-bottom:36px;max-width:1000px}
...
<div class="wrap">
  ...
  <p class="stand">A written operating system for a practice that serves families as their personal chief financial officer — the consultative process, the family layer, and the team that delivers it. <em>Two documents: one to understand it, one to work from.</em></p>

  <div class="docs">
    <a class="doc" href="primer.html">
      <p class="icon">🧭</p>
      <h2>The Primer</h2>
      <p>The whole practice in ten chapters. Every idea stated in one line, explained in a paragraph, and opened down to the mechanics when you want them — you choose the depth.</p>
  ...
  <div class="order"><p><b>Read the Primer first</b>, at depth 1, front to back — about ten minutes for the shape of the whole thing. Then open the Playbook when you are about to do something.</p></div>

  <p class="note">Every procedure names its trigger, its owner, its inputs and outputs, and what changes when the practice serves a whole family rather than one member of a larger one. All of it is original writing, informed by the consultative-process literature (Bowen and CEG Worldwide), the family-wealth literature (James E. Hughes Jr. and co-authors), and the practice-management literature (Philip Palaveev); nothing is reproduced from those sources.</p>
</div>
